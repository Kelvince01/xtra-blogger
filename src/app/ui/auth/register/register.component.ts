  ...
  template: `
    <section class="flex flex-col lg:flex-row p-2 w-full">
      <div
        ...
        <form
          [formGroup]="this.authService.signUpForm"
          (ngSubmit)="signUpUser()"
          class="flex flex-col md:w-2/4">
          <label class="text-xl font-semibold mb-3">Full Name</label>
          <input
            type="text"
          ...
          <label class="text-xl font-semibold mb-3">Phone number</label>
          <input
            type="number"
        ...
        transition ease-in duration-150">
            ...
            <div
              ...
              <span class="ml-3 font-semibold">SIGN UP WITH GOOGLE</span>
            </div>
          </div>
        </form>
...
export class RegisterComponent {
  ...
  signUpUser(): void {
    this.authService.signUpUser().catch((error) => {
